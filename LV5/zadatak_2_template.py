...
# zbog broja klasa (3), ima 3 (za svaku klasu po jedan, jer OvR radi binarnih klasifikatora koliko ima klasa)(1xk dimenzije), kod binarne klasifikacije je bio 1 element(1 klasa)
